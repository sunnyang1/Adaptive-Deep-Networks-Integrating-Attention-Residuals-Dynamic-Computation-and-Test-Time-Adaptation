"""
MSE Compressor: Hadamard Rotation + Per-Vector Normalization + Lloyd-Max Quantization.

This is the core compression engine for RaBitQ.
Uses MSE-only compression with per-vector normalization for optimal quality.
"""
...
def unpack_bits(packed: torch.Tensor, bits: int, 
...
class MSECompressor:
    ...
    Pipeline:
        ...
        2. Random Hadamard rotation (if enabled)
