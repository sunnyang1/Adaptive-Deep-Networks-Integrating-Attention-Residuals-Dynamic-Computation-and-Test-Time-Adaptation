...
Provides RaBitQCache class compatible with HF's DynamicCache,
...
class RaBitQCache:
    ...
    Usage:
        ...
        >>> cache = RaBitQCache(key_bits=4, value_bits=2)
    ...
    def _get_compressors(self, layer_idx: int, head_dim: int) -> Tuple[MSECompressor, MSECompressor]:
