"""
Unified TurboQuant V3 API.

Simple, clean interface for KV cache compression.
"""
...
from .cache import V3Cache, CacheConfig
...
class TurboQuantV3:
    """
    Unified TurboQuant V3 interface.
    ...
    def __init__(self, config: Optional[TurboQuantConfig] = None,
                 ...
                 head_dim: int = 64, device: str = 'cpu'):
        """
        Initialize TurboQuant V3.
    ...
    def fit(self, sample_keys: torch.Tensor, sample_values: torch.Tensor) -> 'TurboQuantV3':
        """
    ...
    def as_cache(self, residual_window: Optional[int] = None) -> V3Cache:
        """
    ...
    def memory_stats(self, seq_len: int, num_layers: int = 1,
                    batch_size: int = 1, num_heads: int = 32) -> Dict[str, float]:
        """
...
def create_k4_v2(head_dim: int = 64, device: str = 'cpu') -> TurboQuantV3:
    """
    ...
    """
    return TurboQuantV3(key_bits=4, value_bits=2, head_dim=head_dim, device=device)


def create_k3_v2(head_dim: int = 64, device: str = 'cpu') -> TurboQuantV3:
    """
    ...
    """
    return TurboQuantV3(key_bits=3, value_bits=2, head_dim=head_dim, device=device)


def create_k2_v2(head_dim: int = 64, device: str = 'cpu') -> TurboQuantV3:
    """
    ...
    """
    return TurboQuantV3(key_bits=2, value_bits=2, head_dim=head_dim, device=device)
