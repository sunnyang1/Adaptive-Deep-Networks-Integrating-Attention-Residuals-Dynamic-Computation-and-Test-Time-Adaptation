...
KIVI、KVQuant、GEAR、QJL、RaBitQ 等工作主要聚焦于**空间维度**：即如何在尽量不损失精度的前提下压缩 KV 缓存。相比之下，QASP 并不试图替代这些方法，而是在 ADN 的四维框架中继续处理“几何自适应”和“信息质量选择性”问题。
...
13. A. Zandieh, M. Han, I. Markov, E. Arisoy, and A. Krishnamurthy. RaBitQ: Towards Near-Optimal Quantization via Beta Distribution Exploitation. *arXiv:2501.16499*, 2025.
