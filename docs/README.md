...
### Validation Reports
- **[VALIDATION_REPORT_5_2.md](reports/validation/VALIDATION_REPORT_5_2.md)** - Section 5.2 validation results
...
- **[run_summary_2026-03-29.md](reports/research/run_summary_2026-03-29.md)** - Experiment run summary

## 📚 Guides

- **[LARGE_MODEL_BUILD.md](guides/LARGE_MODEL_BUILD.md)** - Guide for building large models

## 📋 Project Management

- **[progress.txt](project/progress.txt)** - Development progress tracking
...
- [Scripts Documentation](../scripts/README.md) - Script organization guide
- [Results Directory](../results/README.md) - Results organization by date
