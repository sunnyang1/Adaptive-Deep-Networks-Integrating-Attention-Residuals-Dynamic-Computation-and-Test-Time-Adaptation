...
class SmallModelBuilder:
    ...
    def extract_kv_cache(self, batch_size=1, seq_len=1024):
        ...
        with torch.no_grad():
            ...
            values = torch.randn(batch_size, self.config.num_heads, seq_len, head_dim).to(self.device)
...
def test_turboquant_v3(keys, values, head_dim, device='cpu'):
    ...
    for name, v3 in configs:
        ...
        mem_saved_key = 'memory_saved_percent' if 'memory_saved_percent' in stats else 'memory_saved'
