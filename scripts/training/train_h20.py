...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=None,
                       help='Auto-estimated if not specified')
    ...
    parser.add_argument('--use-deepspeed', action='store_true',
                       help='Use DeepSpeed for Large model')
    ...
    if args.batch_size is None:
        ...
        if is_main_process:
            print(f"Auto-estimated batch size: {args.batch_size} (per GPU: {args.batch_size // world_size})")
