...
from src.turboquant.polar_quant import HadamardTransform, CartesianToPolar, LloydMaxQuantizer
...
class TestQJL:
    ...
    def test_unbiased_estimation(self):
        ...
        for i in range(num_samples):
            est = qjl.decompress_for_dot_product(signs[i : i + 1], query[i : i + 1])
...
class TestTurboQuantPipeline:
    ...
    def test_dot_product_with_correction(self):
        ...
        approx_dot = turbo.decompress_for_dot_product(r, theta, qjl_signs, x_norm, query)
